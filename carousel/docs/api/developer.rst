...
Developers
==========
The next few sections describe the API, developing models with Carousel and
making contributions.

Introduction
------------
Carousel is designed to be easily extensible. Adding new calculations,
formulas, data, outputs, simulations and models is standardized, facilitating
development by many users.

Layers
~~~~~~
The structure of Carousel is divided into five layers:
...
validates itself and executes commands. There can be many Carousel models
with different combinations of layers and different commands. Carousel can
