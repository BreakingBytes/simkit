...
:meth:`~simkit.core.layers.Layer.load` methods. The add method adds
a particular format such as a
:class:`~simkit.core.data_sources.DataSource`. The open method gets
data from a file in the format that was added. The
:meth:`~simkit.core.layers.Layer.load` method loads the layer into
the model. The :meth:`~simkit.core.layers.Layer.load` method must
be implemented in each subclass of
:class:`~simkit.core.layers.Layer` or
...
from simkit.core.simulations import SimRegistry, Simulation
from simkit.core.data_sources import DataRegistry, DataSource
from simkit.core.formulas import FormulaRegistry, Formula
from simkit.core.calculations import CalcRegistry, Calc
from simkit.core.outputs import OutputRegistry, Output
...
class Data(Layer):
    ...
    to SimKit is used. External data files should specify the path.
    """
