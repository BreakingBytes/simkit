...
from flying_circus.core import UREG, Q_
...
class DataReader(object):
    """
    Required interface for all FlyingCircus data readers.
...
class NumPyLoadTxtReader(DataReader):
    ...
    must be specified, as names are required for all data in FlyingCircus. Some
...
class NumPyGenFromTxtReader(DataReader):
    ...
    data in FlyingCircus. Some of the other :func:`numpy.genfromtxt` arguments:
    ...
    :exc:`~flying_circus.core.circus_exceptions.UnnamedDataError`.
...
def _read_header(f, header_param):
    ...
    :rtype: dict
    :raises: :exc:`~flying_circus.core.circus_exceptions.UnnamedDataError`
...
class MixedTextXLS(XLRDReader):
    ...
    :raises: :exc:`~flying_circus.core.circus_exceptions.MixedTextNoMatchError`
    ...
    :exc:`~flying_circus.core.circus_exceptions.MixedTextNoMatchError`
