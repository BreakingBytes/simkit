...
Developers
==========
The next few sections describe the API, developing models with FlyingCircus and
making contributions.

Introduction
------------
FlyingCircus is designed to be easily extensible. Adding new calculations,
formulas, data, outputs, simulations and models is standardized, facilitating
development by many users.

Layers
~~~~~~
The structure of FlyingCircus is divided into five layers:
...
validates itself and executes commands. There can be many FlyingCircus models
with different combinations of layers and different commands. FlyingCircus can
