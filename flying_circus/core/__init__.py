# -*- coding: utf-8 -*-
"""
This is the FlyingCircus core package. FlyingCircus is extensible through its
...
class Registry(dict):
    ...
    def register(self, newitems, *args, **kwargs):
        ...
        :type kwargs: mapping
        :raises:
            :exc:`~flying_circus.core.circus_exceptions.DuplicateRegItemError`,
            :exc:`~flying_circus.core.circus_exceptions.MismatchRegMetaKeysError`
        """
...
class FlyingCircusJSONEncoder(json.JSONEncoder):
    def default(self, o):
        """
        ...
        if isinstance(o, Q_):
            ...
            return super(FlyingCircusJSONEncoder, self).default(o)
