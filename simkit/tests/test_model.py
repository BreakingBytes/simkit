...
from simkit.tests import PROJ_PATH, sandia_performance_model, logging
import os
...
def test_simkit_model():
    ...
    simkit_model_test0 = sandia_performance_model.SAPM(model_test_file)
    ok_(isinstance(simkit_model_test0, Model))
    # path to JSON parameter file specified as class attributes
    simkit_model_test1 = PVPowerSAPM1()
    ok_(isinstance(simkit_model_test1, Model))
    # layers defined as class attributes directly in model class definition
    simkit_model_test2 = PVPowerSAPM2()
    ok_(isinstance(simkit_model_test2, Model))
    # layer classes specified as class attributes
    simkit_model_test3 = PVPowerSAPM3()
    ok_(isinstance(simkit_model_test3, Model))
    # same as test #3 but no data files are specified
    simkit_model_test4 = PVPowerSAPM4()
    ok_(isinstance(simkit_model_test4, Model))
    simkit_model_test4_data = getattr(simkit_model_test4, 'data')
    simkit_model_test4_data.open(
