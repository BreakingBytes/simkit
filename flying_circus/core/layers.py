# -*- coding: utf-8 -*-
"""
This is the Layers module. There are five layers in a FlyingCircus model:
...
:meth:`~flying_circus.core.layers.Layer.load` methods. The add method adds
a particular format such as a
:class:`~flying_circus.core.data_sources.DataSource`. The open method gets
data from a file in the format that was added. The
:meth:`~flying_circus.core.layers.Layer.load` method loads the layer into
the model. The :meth:`~flying_circus.core.layers.Layer.load` method must
be implemented in each subclass of
:class:`~flying_circus.core.layers.Layer` or
...
from flying_circus.core.outputs import OutputRegistry
...
class Data(Layer):
    ...
    :type data: :class:`~flying_circus.core.data_sources.DataRegistry`
