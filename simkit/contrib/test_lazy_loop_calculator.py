...
from simkit.core import Registry, UREG
from simkit.core.formulas import FormulaRegistry
from simkit.core.data_sources import DataRegistry
from simkit.core.outputs import OutputRegistry
# from uncertainty_wrapper import unc_wrapper_args
from simkit.contrib.lazy_looping_calculator import (
...
class TestRegistry(Registry):
    """A mock SimKit registry for testing."""
    meta_names = ['testdata']
