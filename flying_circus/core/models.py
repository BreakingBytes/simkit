# -*- coding: utf-8 -*-
"""
This is the FlyingCircus model module. The model module contains the definition
for the Model class. In general a Model contains Layers.

The FlyingCircus model contains five layers:
:class:`~flying_circus.core.layers.Data`,
:class:`~flying_circus.core.layers.Formulas`,
:class:`~flying_circus.core.layers.Calculation`,
:class:`~flying_circus.core.layers.Outputs` and
:class:`~flying_circus.core.layers.Simulation`. The
:class:`~flying_circus.core.layers.Data` layer organizes
:ref:`data-sources` by providing methods to add and load data for FlyingCircus.
The :class:`~flying_circus.core.layers.Formulas` layer loads
:ref:`formulas` used by :class:`~flying_circus.core.layers.Calculation`
calculations. The :class:`~flying_circus.core.layers.Outputs` layer
organizes the calculated outputs for use in other calculations. Finally the
:class:`~flying_circus.core.layers.Simulation` layer organizes
...
LAYERS_MOD = '.layers'
LAYERS_PKG = 'flying_circus.core'


class Model(object):
    """
    A class for models. FlyingCircus is a subclass of the :class:`Model` class.
    ...
    def edit(self, layer, item, delete=False):
        ...
        :param delete: Flag to return
            :class:`~flying_circus.core.layers.Layer` to delete item.
        :type delete: bool
        """
