...
"""
simkit-quickstart.py command-line script - more info in docs/api/scripts
"""
...
import os
import re
from simkit import __version__
import sys
...
"""
DESCRIPTION = """
Create a SimKit project file structure. See documentation for more detail.
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('project', help='name of SimKit project to create')
    ...
    LOGGER.info('SimKit quickstart completed.')
