...
.. autoclass:: Simulation
   ...
   .. py:attribute:: path
      ...
      path where Carousel simulation files are stored, defaults to
      `Carousel/Simulations` in the `$HOME` directory
   ...
   .. py:attribute:: write_frequency
      ...
      :attr:`~carousel.core.simulations.Simulation.number_intervals`
