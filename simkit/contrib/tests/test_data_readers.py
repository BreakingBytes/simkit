...
from simkit.contrib.readers import (
...
class MyModel(models.Model):
    ...
    :class:`~simkit.contrib.readers.DjangoModelReader`.
    """
...
def test_arg_reader():
    """
    Test :class:`~simkit.contrib.readers.ArgumentReader` is instantiated and
...
def test_arg_data_src():
    """
    Test :class:`simkit.core.data_sources.DataSource` can be instantiated with
    an :class:`~simkit.contrib.readers.ArgumentReader` and that it can
...
def test_django_reader():
    """
    Test :class:`~simkit.contrib.readers.DjangoModelReader` is instantiated
...
def test_hdf5_reader():
    """
    Test :class:`simkit.contrib.readers.HDF5Reader`
